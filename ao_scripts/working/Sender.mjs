...
// Test txids with model data for embedder_test
const txids = [
    "SJZDOfofalIZCJHFPp_PD6qIOy5z4uAo9x8bR7BMnQE",
    "F64fA1xY14Es_y1nBzGUn2jI5ssyBKMF5g7Bs45WxAA",
    "xz6vEtFWUMtKZ-0IfNyDYgoPD-rL1slbWSupC7D7Ys8",
    "u47fgRh7BsO9y1F10LWHlkvLPNT3AN9FxUSQBu_mSSA",
    "OW6uAUv7yryg_FmE2BGMNZXB3o-tBu_6ArNW-1b9SWc",
    "4MsovnReg7_33LU8TIaHokI70TPIOzs1a4DTCZD-KYE",
    "W1xlaxiq97BNHoXy4R0SFUEUompzKEXWumyxzA71zbQ",
    "ZK8MwEUPFlB4AsQzxlgw2QwDNJV6m-hMmlNqJnKF6_o",
    "ZLFtroPenWf0_YHE67ASEo60117GDiUqqaGaXDGC0qM",
    "3Z2OR6WoyqurziDZtgGYwoWBht7OdDMHdjsEiZq0w98",
    "0q6nRHxB76ML4WyCGE08p1sYcelY_n2p3tTBF9KK0C0",
    "gB4cHjWNXLYPCX5TNutlCS9-ggC6JABNyWT1OBlb_EU",
    "foUzXlGxR42Y1Xrn10uksoLv6-mpdRiKVdmtUlaTqPY",
    "tcrT4M35ICCtGwqr355O7XUwiR6M-btfygBOpn8DlP8",
    "AZnAjhsU_a3vDij6vUM1SNV_jeblD_A-kkSXFB56f0o",
    "lSRAVmxumZtX_u88jYbD_E9f4W2-fI2fhYtP5WKv2IM",
    "XjLAtwVSTp0vHpJtrFL9XnofN0I2ouJL2v--FQrBTOk",
    "XFYvEo79TWsrml4FFIs_Mr5reDifTOxLIcXIhYNtN6A",
    "qAtOx-c1BuxqKa8ooRoKafU9Z5gdf-Vwy5bAaFLKq5M",
    "QTw0y5RAWGwk78TfQfDyWzIvjDmFcoIGqj1HheTemIY",
    "a3lEy1mGQAqmhXcNGhAiCzwqggKHqAuBWUA29Ncxqu4",
    "r-7kBU5PfywKuQBRHbAhzu3zrptn-wcNjnoFgSYf2aU",
    "J-ewDjkAtxbmkwgipiFSs0QHXZyJmEeUeXfaWjRRppI",
    "crMZzb8wcIFH-fY87yLr44vdoCSC3IWshUCMUmrpiso",
    "7QysQYWzHmDuArqTyqfgMtN9QqFhq799Dadi_nE5fnU",
    "APZSxlRssjF3S9ca1yjA7JjXAZXfnE-7_9LNmuOJ56s",
    "tlotCE3gVXxjPTUSrw-AxGp4DLOqdCEiD2aHQF8Etmw",
    "42s5xStsfEr7M_ceFAGFxWj5tZuH28gtIg8LyTHMsh8",
    "0retVWIqGgCq8LBoHP6wbjvUOVbp-g16SRCuzwaI4BA",
    "JUChQByHJuVU0CwUuNPBBKOSkOHdZtYF_Jjvvafc5Gc"
]
...
const target = "DWvGJU2-GyO4zQd2WcD21yfQqFOuasLlmFfCYqYvfpQ"

// const action = "GetVec"
const action = "AddToModel"

// loop through the txids and send messages to the target
for (let i = 0; i < txids.length; i++) {
  await message({
    process: target,
    tags: [
      { name: "Action", value: action },
      { name: "TXID", value: txids[i] },
    ],
